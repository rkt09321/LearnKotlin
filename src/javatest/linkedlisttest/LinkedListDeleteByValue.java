...
public class LinkedListDeleteByValue { 
	...
	public static LinkedListDeleteByValue insert(LinkedListDeleteByValue list, int data) 
	{ 
	...
	public static void printList(LinkedListDeleteByValue list) 
	{ 
	...
	public static LinkedListDeleteByValue deleteByKey(LinkedListDeleteByValue list, int key) 
	{ 
		// Store head node 
